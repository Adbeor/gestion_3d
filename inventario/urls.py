...
urlpatterns = [
    ...
    path("api/mover-pago/", views.actualizar_estado_pago, name="api_mover_pago"),
    path("api/stock-pieza/<int:pieza_id>/", views.api_control_stock_pieza, name="api_control_stock_pieza"),
    path("api/stock-producto/<int:producto_id>/", views.api_actualizar_stock_producto, name="api_actualizar_stock_producto"),
