...
class PedidoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "fecha_entrega_estimada": forms.DateInput(
                attrs={"type": "date", "class": "form-control"}
            ),
            "cliente": forms.Select(
                attrs={"class": "form-control select-cliente"}
            ),  # Clase para JS
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email": forms.EmailInput(
                attrs={"class": "form-control", "placeholder": "Correo (Opcional)"}
            ),
            "direccion": forms.Textarea(
                attrs={"class": "form-control", "rows": 2, "placeholder": "Dirección"}
            ),
        }
...
ItemPedidoFormSet = inlineformset_factory(
    ...
    widgets={
        ...
        "texto_dedicatoria": forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Dedicatoria..."}
        ),
    },
)
